...
const LEVELS = [
  ...
  },
  {
    ...
    waves: [
      ...
      [{ type:"healer",   count:3,  gap:2.0 }, { type:"shield", count:6, gap:0.9 }, { type:"cavalry", count:16, gap:0.32 }],
    ],
  },
  {
    name: "夷陵之战",
    intro: "火烧连营七百里，决死收官之战！",
    gold: 350, hp: 16,
    ...
    waves: [
      ...
      [{ type:"siege",    count:3,  gap:1.8 }, { type:"healer", count:3, gap:2.5 }, { type:"shield", count:8, gap:0.8 }, { type:"infantry", count:20, gap:0.3 }],
    ],
  },
  ...
  },
  {
    ...
    waves: [
      ...
      [{ type:"siege",    count:1,  gap:1.0 }, { type:"shield", count:6, gap:1.0 }, { type:"cavalry", count:14, gap:0.34 }],
    ],
  },
  {
    name: "江陵争夺",
  ...
  },
  {
    ...
    waves: [
      ...
      [{ type:"healer",   count:3,  gap:1.8 }, { type:"cavalry", count:24, gap:0.26 }, { type:"shield", count:8, gap:0.8 }],
    ],
  },
  {
    name: "陈仓鏖兵",
  ...
  },
  {
    ...
    waves: [
      ...
      [{ type:"siege",    count:4,  gap:1.6 }, { type:"healer", count:3, gap:2.0 }, { type:"shield", count:10, gap:0.7 }, { type:"cavalry", count:14, gap:0.34 }],
    ],
  },
  {
    name: "剑阁天险",
    intro: "姜维守剑阁，以一当万，蜀汉存续在此一战！",
    gold: 380, hp: 14,
    ...
    waves: [
      ...
      [{ type:"siege",    count:5,  gap:1.4 }, { type:"healer", count:4, gap:1.8 }, { type:"shield", count:12, gap:0.65 }, { type:"cavalry", count:18, gap:0.3 }],
    ],
  },
];
