...
const LEVELS = [
  {
    ...
    tags: ["Boss教学", "混编入门"],
    threats: ["末波吕布会冲锋突破防线", "步兵与骑兵混编，漏怪点分散"],
    recommends: ["保留空城计压住吕布冲锋", "用高单体输出集中处理 Boss"],
  ...
  },
  {
    ...
    tags: ["经济压力", "攻城车"],
    threats: ["起手军粮偏紧，过早刷新会拖慢布防", "攻城车伤城重，需要提前集火"],
    recommends: ["优先选低费与经济型武将", "留一名近战高伤武将处理攻城车"],
    rulesText: ["全体击杀军粮 -10%"],
    rules: { rewardMul: 0.9 },
  ...
  },
  {
    ...
    tags: ["范围清场", "召唤Boss"],
    threats: ["曹操会召唤骑兵并加速周围敌军", "末波兵量密集，单体输出容易漏后排"],
    recommends: ["优先带谋士与溅射武将", "用火计清密集波次，空城计留给 Boss 光环段"],
    rulesText: ["火计冷却 -20%"],
    rules: { skillCdMul: { fire: 0.8 } },
  ...
  },
  {
    ...
    tags: ["高速骑兵", "控制"],
    threats: ["多波骑兵速度快，容易从火力空窗穿过", "盾兵会拖住近战输出节奏"],
    recommends: ["带减速、眩晕或远射程武将", "沿长直路段布置持续火力"],
    rulesText: ["骑兵速度 +12%"],
    rules: { enemySpeedMul: { cavalry: 1.12 } },
  ...
  },
  {
    ...
    tags: ["重甲医阵", "冲锋Boss"],
    threats: ["盾兵与军医组合会拖长战线", "夏侯渊高频冲锋，容易突然破城"],
    recommends: ["破甲、高伤和远射程都很关键", "优先点杀军医，再集火盾兵与 Boss"],
    rulesText: ["盾兵额外护甲 +2", "空城计冷却 +10%"],
    rules: { enemyArmorBonus: { shield: 2 }, skillCdMul: { fort: 1.1 } },
  ...
  },
  {
    ...
    tags: ["持续压力", "混编收官"],
    threats: ["医盾骑车连续混编，容错比前几关低", "陆逊残血狂暴并召唤援军"],
    recommends: ["带稳定范围输出和控制", "城防不高，避免把军粮全压在刷新上"],
    rulesText: ["军医治疗 +15%", "攻城车破城伤害 +1"],
    rules: { healerPowerMul: 1.15, castleDamageMul: { siege: 1.25 } },
  ...
  // ============================================================
  {
    ...
    tags: ["火攻试炼", "前中期混编"],
    threats: ["骑兵和盾兵交替出现，火力节奏容易被打断", "路线转折多，短射程武将容易覆盖不足"],
    recommends: ["优先谋士范围伤害与射程光环", "把主力放在多段路线交汇处"],
    rulesText: ["火计冷却 -15%"],
    rules: { skillCdMul: { fire: 0.85 } },
  ...
  },
  {
    ...
    tags: ["铁壁Boss", "盾兵"],
    threats: ["曹仁自愈且抗控，拖太久会吞掉大量输出", "盾兵比例提升，低伤多段攻击收益下降"],
    recommends: ["带破甲或高单发伤害武将", "用光环提高主力输出，而不是只堆低费塔"],
    rulesText: ["盾兵生命 +10%", "Boss 护甲 +2"],
    rules: { enemyHpMul: { shield: 1.1 }, enemyArmorBonus: { boss: 2 } },
  ...
  },
  {
    ...
    tags: ["骑盾推进", "要津争夺"],
    threats: ["骑兵穿插盾兵之后，容易在后段冲出火力圈", "攻城车夹在中波，必须留输出窗口"],
    recommends: ["搭配控制与近战爆发", "不要只守入口，后段转角也要补火力"],
    rulesText: ["骑兵速度 +8%", "盾兵生命 +8%"],
    rules: { enemySpeedMul: { cavalry: 1.08 }, enemyHpMul: { shield: 1.08 } },
  ...
  },
  {
    ...
    tags: ["军医续航", "入川拉锯"],
    threats: ["军医反复抬血，拖慢击杀节奏", "盾兵护住后排会吃掉大量火力"],
    recommends: ["优先带收割、破甲和范围清后排", "火计适合处理军医聚团波次"],
    rulesText: ["军医治疗 +25%"],
    rules: { healerPowerMul: 1.25 },
  ...
  },
  {
    ...
    tags: ["医盾重甲", "资源拉扯"],
    threats: ["盾兵、军医、攻城车同时出现，击杀顺序很重要", "城池血量降低，漏车代价更高"],
    recommends: ["带经济型武将补军粮，也要有破甲点", "先清军医，再处理攻城车"],
    rulesText: ["盾兵额外护甲 +2", "军医治疗 +15%"],
    rules: { enemyArmorBonus: { shield: 2 }, healerPowerMul: 1.15 },
  ...
  },
  {
    ...
    tags: ["治疗海", "机关阻滞"],
    threats: ["军医数量多，敌军会在中段反复回血", "混入骑兵后会考验控制覆盖"],
    recommends: ["带减速、范围伤害和击杀爆发", "用控制拖住治疗圈内的密集敌群"],
    rulesText: ["军医治疗 +35%", "骑兵速度 +6%"],
    rules: { healerPowerMul: 1.35, enemySpeedMul: { cavalry: 1.06 } },
  ...
  },
  {
    ...
    tags: ["高速突袭", "Boss召骑"],
    threats: ["高速骑兵潮多，路线短窗口少", "张郃会冲锋并继续召唤骑兵"],
    recommends: ["射程光环、减速和眩晕收益很高", "阵容不要过重，前期必须快速成型"],
    rulesText: ["骑兵速度 +15%", "空城计冷却 +10%"],
    rules: { enemySpeedMul: { cavalry: 1.15 }, skillCdMul: { fort: 1.1 } },
  ...
  },
  {
    ...
    tags: ["攻城车阵", "阵地战"],
    threats: ["攻城车数量明显提升，漏一辆就很痛", "盾兵和军医会保护车阵推进"],
    recommends: ["带高单体、破甲和成长型输出", "主力布在攻城车停留时间最长的转角"],
    rulesText: ["攻城车生命 +12%", "攻城车破城伤害 +25%"],
    rules: { enemyHpMul: { siege: 1.12 }, castleDamageMul: { siege: 1.25 } },
  ...
  },
  {
    ...
    tags: ["全兵种考验", "光环Boss"],
    threats: ["司马懿给敌军加速和护甲，还会召盾", "全兵种混编考验阵容完整度"],
    recommends: ["尽量凑成核心羁绊再入关", "光环、破甲、范围和控制都要覆盖"],
    rulesText: ["Boss 生命 +10%", "盾兵额外护甲 +1"],
    rules: { enemyHpMul: { boss: 1.1 }, enemyArmorBonus: { shield: 1 } },
  ...
  },
  {
    ...
    tags: ["终局Boss", "最高混编"],
    threats: ["邓艾冲锋、召唤、狂暴、抗控兼具", "医盾车骑全量压上，城池容错最低"],
    recommends: ["使用成型羁绊与最强培养武将", "保留技能给 Boss 狂暴和末波车阵"],
    rulesText: ["Boss 生命 +15%", "骑兵速度 +10%", "军医治疗 +20%"],
    rules: { enemyHpMul: { boss: 1.15 }, enemySpeedMul: { cavalry: 1.1 }, healerPowerMul: 1.2 },
